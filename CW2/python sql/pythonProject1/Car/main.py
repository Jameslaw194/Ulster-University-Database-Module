...
# File paths
input_file = "car_data.txt"  # Replace with the actual file path
output_file = "car_data.sql"  # The file to save the generated SQL statement

# Table and column configuration
table_name = "Car"  # Replace with your actual table name
columns = [
    "registration",
    "make",
    "model",
