...
# File paths
input_file = "customer_data.txt"  # Replace with the actual file path
output_file = "customer_data.sql"  # The file to save the generated SQL statement
...
def format_value(value, column_name):
    ...
    if column_name in {"dropoff_date", "next_service"}:
